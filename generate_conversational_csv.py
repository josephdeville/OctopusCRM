...
from playbook_messages_conversational import messages

# Read the original CSV
input_file = 'octopus_export-message_clayworks_1_12_2026.csv'
output_file = 'octopus_export-message_clayworks_1_12_2026_conversational.csv'
